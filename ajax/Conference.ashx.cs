        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else if (context.Request.RequestType == "POST")
            {
                if (context.Request["action"].ToString() == "vote" && Classes.User.IsLogin)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT [notvoted], [consented], [rejected], [abstained], [nvvote], [cvote], [rvote], [avote], [ratio], [active] FROM [Votes] WHERE [id]=@id");
                    ...
                    if (r["active"].ToString() == "True" && notvoted.Contains(uid))
                    {
                        ...
                        else if (context.Request.Form["decision"].ToString() == "A")
                        {
