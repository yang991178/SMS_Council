        ...
        <div class="container">
            ...
            <div *ngIf="notvoted">
                ...
                <table class="bordered">
                    <thead><tr><th>姓名</th><th>投票</th><th></th></tr></thead>
                    <tbody>
                        <tr *ngFor="let user of notvoted"><td>{{user.name}}</td><td><a (click)="adminVote('C', user.id)" class="green-text" href="javascript:void(0)">赞成</a></td><td><a (click)="adminVote('R', user.id)" class="red-text" href="javascript:void(0)">反对</a></td></tr>
            ...
            <div *ngIf="consented">
                ...
                <table class="bordered">
                    ...
                    <tbody>
                        <tr *ngFor="let user of consented"><td>{{user.name}}</td></tr>
            ...
            <div *ngIf="rejected">
                ...
                <table class="bordered">
                    <thead><tr><th>姓名</th></tr></thead>
                    <tbody>
                        <tr *ngFor="let user of rejected"><td>{{user.name}}</td></tr>
...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    getUserList(type: number): User[] {
        ...
        var search = type == 1 ? this.vote.notvoted : (type == 2 ? this.vote.consented : this.vote.rejected);
